...
return {
    families = {
        ...
        { id = "ui-core",       core = false, deps = { "core", "ui-theme" },                                description = "UI core utilities: AnchorUtil, FrameUtil, RegionUtil, WindowUtil",                    files = { "UI/Core/AnchorUtil.lua", "UI/Core/FrameUtil.lua", "UI/Core/RegionUtil.lua", "UI/Core/WindowUtil.lua" } },
    ...
    presets = {
        ...
        loothing = { description = "Loothing loot council addon runtime requirements", families = { "core-ext" } },
