...
return {
    families = {
        ...
        { id = "config",    core = true,  deps = { "core", "events", "data" },        description = "Configuration system: types, registry, slash commands, profiles, dialog",       files = { "Config/ConfigTypes.lua", "Config/ConfigRegistry.lua", "Config/ConfigCmd.lua", "Config/ProfileOptions.lua", "Config/DialogTheme.lua", "Config/ConfigDialog.lua", "Config/Config.lua" } },
