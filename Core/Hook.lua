...
-- @param handler function|string - Handler function or method name
-- @return boolean - Success
function HookMixin:RawHookScript(frame, script, handler)
    self:_InitHooks()
...
-- @param handler function|string - Handler function or method name
-- @return boolean - Success
function HookMixin:SecureHookScript(frame, script, handler)
    self:_InitHooks()
...
-- @param script string - Script name
-- @return boolean - Success
function HookMixin:UnhookScript(frame, script)
