...
local LoolibCallbackRegistryMixin = assert(Loolib.CallbackRegistryMixin, "Loolib/Events/CallbackRegistry.lua must be loaded before CanvasBrush")
...
local LoolibCanvasBrushMixin = Loolib.CreateFromMixins(LoolibCallbackRegistryMixin)
...
local function LoolibCreateCanvasBrush()
    local brush = {}
    Loolib.Mixin(brush, LoolibCanvasBrushMixin)
    brush:OnLoad()
    return brush
end
